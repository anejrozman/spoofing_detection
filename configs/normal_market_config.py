...
#  Author: Anej Rozman
# 
#  Description: This is configuration file for a normal market simulation without spoofing agents, and 
#  follows the rmsc04 configuration from JP Morgan's paper: ABIDES-Gym: Gym Environments for 
#  Multi-Agent Discrete Event Simulation and Application to Financial Markets
#  The paper is accessible here: https://arxiv.org/pdf/2110.14771
# 
